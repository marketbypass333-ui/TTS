#!/usr/bin/env python3
"""
Standalone test for Thai text preprocessing functionality.
"""

import re
import unicodedata

# Import Thai modules directly
import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'TTS/tts/utils/text'))

# Import the Thai modules directly
exec(open('/home/user/webapp/TTS/tts/utils/text/thai/__init__.py').read())
exec(open('/home/user/webapp/TTS/tts/utils/text/thai/cleaners.py').read())
exec(open('/home/user/webapp/TTS/tts/utils/text/thai/numbers.py').read())
exec(open('/home/user/webapp/TTS/tts/utils/text/thai/phonemes.py').read())
exec(open('/home/user/webapp/TTS/tts/utils/text/thai/text_processor.py').read())
